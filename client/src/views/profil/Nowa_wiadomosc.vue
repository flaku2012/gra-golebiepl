<template>
    <div>
        <h3 class="text-center">Nowa wiadomość</h3>
        <div class="btn-group" role="group" aria-label="Basic example">
            <router-link to="wiadomosci" class="btn btn-success btn-sm">Wiadomości</router-link>
        </div>
        <hr>

        <form>
            <div class="mb-3 row">
                <label for="staticEmail" class="col-sm-2 col-form-label">Odbiorca</label>
                <div class="col-sm-10">
