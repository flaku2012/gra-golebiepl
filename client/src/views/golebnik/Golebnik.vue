                        ...
                        <div class="modal-body">
                            <form @submit.prevent="addFood">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select" v-model="form.storehouseId">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="count" v-model.number="form.count">
                                    <p class="text-danger" v-if="errorsAddFood.count">{{errorsAddFood.count[0]}}</p>
                                    <p class="text-primary">Pozostałe miejsce: {{pigeonHawk.max_level_food-pigeonHawk.level_food-form.count}} kg</p>
    ...
    async function addFood()
    {
        try{
            await axios.post('pigeonhawks/add_food_to_hawk',{
                'storehouse_id': form.storehouseId,
                'count':  form.count,
